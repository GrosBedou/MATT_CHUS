...
def is_circular(contour, circularity_threshold=0.4):  # Adjusted threshold
...
video_path = '/Users/abedard/Desktop/MATT technique/Test28mai/Utilise/P1_JD_5N.MOV'
...
while cap.isOpened():
    ...
    lower_yellow = np.array([21, 100, 100])  # Adjusted lower bound
    upper_yellow = np.array([40, 255, 255])  # Adjusted upper bound
